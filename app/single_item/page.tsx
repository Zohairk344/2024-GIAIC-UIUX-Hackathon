  ...
  return (
    <div className='poppins'>
        ...
        <div className='flex flex-row'>
          ...
          <div className='flex flex-col'>
            ...
            <div className='flex flex-row'>
              ...
              <div className='mt-10 pt-5 ml-6 w-[220px] border border-black rounded-xl justify-center items-center text-center'><h1 className='text-xl'>Add To Cart</h1></div>
              <div className='mt-10 pt-5 ml-6 w-[220px] border border-black rounded-xl justify-center items-center text-center'><h1 className='text-xl'>+ Compare</h1></div>
            </div>
        ...
        <div className='flex flex-col'>
          ...
          <Image src="/single_item/Group_109.svg" alt='' width={1920} height={500} className='my-16'/>
        </div>
