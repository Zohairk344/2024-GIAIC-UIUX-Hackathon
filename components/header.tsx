  ...
  return (
    ...
    <div className='flex flex-row py-4 poppins bg-white'>
        ...
        <div className='flex flex-row ml-96 gap-20'>
            ...
            <div className='flex flex-row'>
                <Link href="/"><p className=' mt-3 mr-10 text-lg'>Blog</p></Link>
            </div>

            <div className='flex flex-row'>
                <Link href="/"><p className=' mt-3 mr-10 text-lg'>Contact</p></Link>
            </div>
            ...
            <div className='flex flex-row gap-8 pl-28'>
                ...
                <Link href="/single_item"><Image src={Heart_Icon} alt="" width={30} height={30} className='mt-2 mr-10' /></Link>
